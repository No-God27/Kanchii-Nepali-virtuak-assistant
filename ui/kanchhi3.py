...
class Ui_HomePage(QtWidgets.QWidget):
    ...
    def setupUi(self, widget):
        ...
        self.BackGround.setPixmap(QtGui.QPixmap("images/bluu.png"))
        ...
        self.Background2.setPixmap(QtGui.QPixmap("images/bluu.png"))
        ...
        self.Background3.setPixmap(QtGui.QPixmap("images/bluu.png"))
        ...
        self.MicStatusLabel = QtWidgets.QLabel(widget)
        self.MicStatusLabel.setGeometry(QtCore.QRect(700, 450, 64, 64))  # Adjust the position and size as needed
        self.MicStatusLabel.setPixmap(QtGui.QPixmap("images/micoff.png"))
        self.MicStatusLabel.setScaledContents(True)
        self.MicStatusLabel.setObjectName("MicStatusLabel")
    ...
    def start_listening(self):
        if not self.is_listening:
            ...
            self.update_mic_status(True)  # Update mic status to on
    ...
    def stop_listening(self):
        if self.is_listening:
            self.is_listening = False
            self.update_mic_status(False)  # Update mic status to off
    ...
    def update_mic_status(self, is_on):
        if is_on:
            self.MicStatusLabel.setPixmap(QtGui.QPixmap("images/micon.png"))
        else:
            self.MicStatusLabel.setPixmap(QtGui.QPixmap(r"C:\Users\Lenovo\Desktop\ui\images\micoff.png"))
